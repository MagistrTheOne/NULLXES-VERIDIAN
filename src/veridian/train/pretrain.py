...
from veridian.config import (
    load_data_config,
    load_model_config,
    load_training_config,
)
from veridian.data import PackedCausalLMDataset
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Pretrain VERIDIAN from scratch.")
...
def main() -> None:
    ...
    if train_config.use_tf32 and torch.cuda.is_available():
    ...
    use_amp = train_config.device.startswith("cuda")
    amp_dtype = torch.bfloat16 if train_config.bf16 else torch.float16
